...
. ../constants.sh
phony_passphrase="moez"
pr_key_location="./temp_files/unauthorized_root_private.key"
pu_key_location="./temp_files/unauthorized_root_public.key"
...
openssl ec -in $pr_key_location -passin pass:$phony_passphrase -pubout > $pu_key_location
